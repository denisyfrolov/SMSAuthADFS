...
{
    class SmsPresentationFormPin : IAdapterPresentationForm
    {
        private Debug Debug = null;

        public SmsPresentationFormPin()
        {
        }

        public SmsPresentationFormPin(Debug Debug)
        {
            this.Debug = Debug;
        }
        ...
        {
            string htmlTemplate = Resources.MfaFormHtmlPin; // Resxfilename.resourcename
